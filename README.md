...
* Request
  * Method: POST
  * Route path: /api/spots/:spotId/spotImages
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: POST
  * Route path: /api/reviews/:reviewId/reviewImages
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: DELETE
  * Route path: /api/spots/:spotId/spotImages/:imageId
  * Body: none
...
* Request
  * Method: DELETE
  * Route path: /api/reviews/:reviewId/reviewImages/:imageId
  * Body: none
